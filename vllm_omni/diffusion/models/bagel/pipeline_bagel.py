...
class BagelPipeline(nn.Module):
    ...
    def forward(self, req: OmniDiffusionRequest) -> DiffusionOutput:
        ...
        prompt = req.prompts[0] if isinstance(req.prompts[0], str) else (req.prompts[0].get("prompt") or "")
        ...
        injected_metadata = req.sampling_params.extra_args.get("kv_metadata", None)
